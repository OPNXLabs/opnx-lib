...
namespace OPNX.Lib.Streaming.RTSP.Onvif
{
    public static class RtpPacketOnvifUtils
    {
        ...
        public static (ushort frameWidth, ushort frameHeight) ProcessJpegFrameExtension(ReadOnlyMemory<byte> extension)
        {
            return ProcessJpegFrameExtension(extension.Span);
        }
        /// <summary>
        ...
        public static DateTime ProcessRTPTimestampExtension(ReadOnlyMemory<byte> extension, out int headerPosition)
        {
            return ProcessRTPTimestampExtension(extension.Span, out headerPosition);
        }
